package com.duan.fantasies.shm.verify;

import com.duan.fantasies.shm.core.HandlerMethodVerify;
import com.duan.fantasies.shm.verify.annoation.ParamVerifyComposite;
import com.duan.fantasies.shm.verify.annoation.method.*;
import com.duan.fantasies.shm.verify.annoation.parameter.ParamValueVerify;
import com.duan.fantasies.shm.verify.annoation.parameter.ParamVerify;
 ...
 *                     {@code @Override}
 *                     protected Object warpVerifyFailResult(ServletInvocableHandlerMethodArgumentVerify.HandleResult result) {
 *                         Object value = result.value;
 *                         MethodParameter parameter = result.parameter;
 *                         return super.warpVerifyFailResult(result);
 *                     }
 *                 };
 *             }
 *         };
 ...
 */
@Component
public class ServletInvocableHandlerMethodArgumentVerify implements HandlerMethodVerify {

    @Autowired
    private HandlerMethodVerifyFail handlerMethodVerifyFail;

    @Override
    public Object postVerifyBeforeInvoke(ServletInvocableHandlerMethod handlerMethod, Object... args) {
        // 校验参数
        HandleResult result = handleParamVerify(handlerMethod, args);
        if (result != null) {
            // 参数校验未通过
            return handlerMethodVerifyFail.warpVerifyFailResult(result);
        }
    ...
    // 返回 null 表示校验成功，否则失败
    protected HandleResult handleParamVerify(HandlerMethod handlerMethod, Object... args) {
